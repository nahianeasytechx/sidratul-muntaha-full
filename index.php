...
// Fetch activities by type for projects sections
$regularActivities = array_filter(getAllActivities(), function ($activity) {
	return $activity['status'] === 'Active' && $activity['type'] === 'Regular';
});

$financialActivities = array_filter(getAllActivities(), function ($activity) {
	return $activity['status'] === 'Active' && $activity['type'] === 'Financial';
});

$socialActivities = array_filter(getAllActivities(), function ($activity) {
	return $activity['status'] === 'Active' && $activity['type'] === 'Social';
});

// DON'T limit - show all activities
// $regularActivities = array_slice($regularActivities, 0, 3);
// $financialActivities = array_slice($financialActivities, 0, 3);
// $socialActivities = array_slice($socialActivities, 0, 3);
?>
 <style>
		...
		<div class="slider">
			<?php if (!empty($sliders)): ?>
				<?php foreach ($sliders as $index => $slider): ?>
					<div class="slide <?php echo $index === 0 ? 'active' : ''; ?> transition-fade">
						<img src="<?= BASE_URL ?>admin-panel/<?php echo htmlspecialchars($slider['slider_img']); ?>" alt="<?php echo htmlspecialchars($slider['slider_title']); ?>">
						<div class="slide-content">
							<h1 class="slide-title"><?php echo htmlspecialchars($slider['slider_title']); ?></h1>
							<p class="slide-description"><?php echo htmlspecialchars($slider['slider_description']); ?></p>
							<div class="slide-buttons">
								<a href="<?= BASE_URL ?>donate.php" class="hero-btn hero-btn-primary">
									Donate Now
									<i class="fa fa-arrow-right"></i>
								</a>
								<?php if (!empty($slider['project_slug'])): ?>
									<!-- If slider has linked project, go to that project's detail page -->
									<a href="<?= BASE_URL ?>project/<?php echo htmlspecialchars($slider['project_slug']); ?>" class="hero-btn hero-btn-secondary">
										View Project
										<i class="fa fa-angle-right"></i>
									</a>
								<?php else: ?>
									<!-- If no linked project, go to general projects page -->
									<a href="<?= BASE_URL ?>projects.php" class="hero-btn hero-btn-secondary">
										View Projects
										<i class="fa fa-angle-right"></i>
									</a>
								<?php endif; ?>
			...
			<?php else: ?>
				...
				<div class="slide active transition-fade">
					<img src="<?= BASE_URL ?>images/Banner3.jpg" alt="Default Banner">
					<div class="slide-content">
						<h1 class="slide-title">Sidratul Muntaha Foundation</h1>
			...
			<div class="row g-0 align-items-center">
				...
				<div class="col-lg-6 p-5 featured-left">
					...
					<div class="d-flex flex-wrap" style="gap: 20px">
						<a href="<?= BASE_URL ?>about.php" class="hero-btn hero-btn-primary" style="background:#00a854; padding:12px 25px; border-radius:10px; color:#fff; font-weight:600; text-decoration:none;">Know More</a>
						<a href="<?= BASE_URL ?>projects.php" class="hero-btn hero-btn-outline" style="border:2px solid rgb(255, 255, 255); padding:12px 25px; border-radius:10px; color: #fff; font-weight:600; text-decoration:none;">Projects</a>
					</div>
				</div>
				...
				<div class="col-lg-6 p-5 featured-right text-center">
					<img src="<?= BASE_URL ?>images/final-logo.png" alt="Logo" class="featured-logo mb-4"><br><br>
			...
			<div class="col-lg-4 col-md-6 mb-4">
				<div class="mission-card">
					...
					<div class="text-center mt-5" data-aos="fade-up">
						<a href="<?= BASE_URL ?>about.php" class="see-all-btn">
							See More
							<i class="fa fa-arrow-right"></i>
						</a>
					</div>
...
<!-- Major Projects - Financial Activities -->
<div class="projects-section">
	<div class="container">
		...
		<div class="row" data-aos="fade-up" data-aos-delay="200">
			<?php if (!empty($financialActivities)): ?>
				<?php foreach ($financialActivities as $activity): ?>
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="project-card">
							<div class="project-img">
								<?php
								// Use same logic as projects.php page
								$projectImage = 'images/Hospital Project.jpg'; // default placeholder
								if (!empty($activity['image'])) {
									$projectImage = preg_replace('/^\.\.\//', '', $activity['image']);
								}
								?>
								<img src="<?= BASE_URL ?><?php echo htmlspecialchars($projectImage); ?>" alt="<?php echo htmlspecialchars($activity['title']); ?>">
							</div>
							<div class="project-body">
								<h3 class="project-title"><?php echo htmlspecialchars($activity['title']); ?></h3>
								<p class="project-text text-turncate"><?php echo htmlspecialchars($activity['short_description']); ?></p>
								<a href="<?= BASE_URL ?>donate.php" class="project-btn mt-3">
									Donate Now
									<i class="fa fa-arrow-right"></i>
								</a>
							</div>
				...
				<?php endforeach; ?>
			<?php else: ?>
				<!-- Fallback if no financial activities -->
				<div class="col-lg-4 col-md-6 mb-4">
					<div class="project-card">
						<div class="project-img">
							<img src="<?= BASE_URL ?>images/Hospital Project.jpg" alt="Hospital">
						</div>
						<div class="project-body">
				...
				<div class="col-lg-4 col-md-6 mb-4">
					<div class="project-card">
						<div class="project-img">
							<img src="<?= BASE_URL ?>images/school.png" alt="School">
						</div>
						<div class="project-body">
				...
				<div class="col-lg-4 col-md-6 mb-4">
					<div class="project-card">
						<div class="project-img">
							<img src="<?= BASE_URL ?>images/mosque.png" alt="Mosque">
						</div>
						<div class="project-body">
		...
		<div class="text-center mt-5" data-aos="fade-up">
			<a href="<?= BASE_URL ?>projects.php" class="see-all-btn">
				View All Projects
				<i class="fa fa-arrow-right"></i>
			</a>
		</div>
...
<!-- Social Projects - Social Activities -->
	...
	<div class="container">
		...
		<div class="courses_slider_container" data-aos="fade-up" data-aos-delay="200">
			<div class="owl-carousel owl-theme courses_slider">
				<?php if (!empty($socialActivities)): ?>
					<?php foreach ($socialActivities as $activity): ?>
						<div class="owl-item">
							<div class="course">
								<div class="course_image">
									<a href="<?= BASE_URL ?>project/<?php echo htmlspecialchars($activity['slug']); ?>">
										<?php if (!empty($activity['image'])): ?>
											<?php
											$imageSrc = !empty($activity['image']) ? preg_replace('/^\.\.\//', '', $activity['image']) : 'images/SocialWork10.jpg';
											?>
											<img src="<?= BASE_URL ?><?php echo htmlspecialchars($imageSrc); ?>" alt="<?php echo htmlspecialchars($activity['title']); ?>">
										<?php else: ?>
											<img src="<?= BASE_URL ?>images/SocialWork10.jpg" alt="<?php echo htmlspecialchars($activity['title']); ?>">
										<?php endif; ?>
									</a>
								</div>
								<div class="course_body">
									<div class="course_header">
										<span class="course_tag"><?php echo htmlspecialchars($activity['type']); ?> Projects</span>
									</div>
									<div class="course_title">
										<h3><a href="<?= BASE_URL ?>project/<?php echo htmlspecialchars($activity['slug']); ?>"><?php echo htmlspecialchars($activity['title']); ?></a></h3>
									</div>
									<div class="course_text text-elipsis"><?php echo htmlspecialchars($activity['short_description']); ?></div>
									<a href="<?= BASE_URL ?>project/<?php echo htmlspecialchars($activity['slug']); ?>" class="project-btn mt-3">
										See Details
										<i class="fa fa-arrow-right"></i>
									</a>
								</div>
					...
					<?php endforeach; ?>
				<?php else: ?>
					<!-- Fallback if no social activities -->
					<div class="owl-item">
						<div class="course">
							<div class="course_image">
								<a href="<?= BASE_URL ?>projects.php">
									<img src="<?= BASE_URL ?>images/SocialWork10.jpg" alt="Relief Distribution">
								</a>
							</div>
							<div class="course_body">
								<div class="course_header">
								...
								<div class="course_title">
									<h3><a href="<?= BASE_URL ?>projects.php">Relief Distribution</a></h3>
								</div>
								...
								<a href="<?= BASE_URL ?>projects.php" class="project-btn mt-3">
									See Details
									<i class="fa fa-arrow-right"></i>
								</a>
							</div>
					...
					<div class="owl-item">
						<div class="course">
							<div class="course_image">
								<a href="<?= BASE_URL ?>projects.php">
									<img src="<?= BASE_URL ?>images/SocialWork2.jpg" alt="Winter Clothing">
								</a>
							</div>
							<div class="course_body">
								<div class="course_header">
								...
								<div class="course_title">
									<h3><a href="<?= BASE_URL ?>projects.php">Winter Clothing Distribution</a></h3>
								</div>
								<div class="course_text">Providing warm clothing to underprivileged families during winter season to protect them from harsh weather conditions.</div>
								<a href="<?= BASE_URL ?>projects.php" class="project-btn mt-3">
									See Details
									<i class="fa fa-arrow-right"></i>
								</a>
					...
					<div class="owl-item">
						<div class="course">
							<div class="course_image">
								<a href="<?= BASE_URL ?>projects.php">
									<img src="<?= BASE_URL ?>images/SocialWork3.jpg" alt="Iftar Meals">
								</a>
							</div>
							<div class="course_body">
								<div class="course_header">
								...
								<div class="course_title">
									<h3><a href="<?= BASE_URL ?>projects.php">Iftar Meals Program</a></h3>
								</div>
								<div class="course_text">Distributing nutritious iftar meals to fasting individuals and families during the holy month of Ramadan.</div>
								<a href="<?= BASE_URL ?>projects.php" class="project-btn mt-3">
									See Details
									<i class="fa fa-arrow-right"></i>
								</a>
...
<div class="associates-section">
	<div class="container">
		...
		<div class="associates-grid" data-aos="fade-up" data-aos-delay="200">
			<img src="<?= BASE_URL ?>images/islami bank img.png" alt="Islami Bank" class="associate-logo">
			<img src="<?= BASE_URL ?>images/assunnah.png" alt="As-Sunnah" class="associate-logo">
			<img src="<?= BASE_URL ?>images/insurancep.png" alt="Insurance" class="associate-logo">
		</div>
	</div>
</div>
