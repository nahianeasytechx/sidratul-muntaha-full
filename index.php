		...
		<div class="slider">
			<?php if (!empty($sliders)): ?>
				<?php foreach ($sliders as $index => $slider): ?>
					<div class="slide <?php echo $index === 0 ? 'active' : ''; ?> transition-fade">
						<img src="./admin-panel/<?php echo htmlspecialchars($slider['slider_img']); ?>" alt="<?php echo htmlspecialchars($slider['slider_title']); ?>">
			...
			<?php else: ?>
				...
				<div class="slide active transition-fade">
					<img src="images/Banner3.jpg" alt="Default Banner">
					<div class="slide-content">
...
<!-- Projects Section - Regular Activities -->
							...
							<div class="course">
								...
								<div class="course_body">
									...
									<div class="course_title">
										<h3><a href="project-details.php?id=<?php echo $activity['id']; ?>"><?php echo htmlspecialchars($activity['title']); ?></a></h3>
									</div>
									<div class="course_text text-elipsis"><?php echo htmlspecialchars($activity['short_description']); ?></div>
									<a href="project-details.php?id=<?php echo $activity['id']; ?>" class="project-btn mt-3">
										See Details
										<i class="fa fa-arrow-right"></i>
									</a>
								</div>
				...
				<?php else: ?>
					...
					<div class="owl-item">
						<div class="course">
							<div class="course_image">
								<a href="project-details.php">
									<img src="images/SocialWork10.jpg" alt="Relief Distribution">
								</a>
							</div>
							<div class="course_body">
								<div class="course_header">
					...
					<div class="owl-item">
						<div class="course">
							<div class="course_image">
								<a href="project-details.php">
									<img src="images/SocialWork2.jpg" alt="Winter Clothing">
								</a>
							</div>
							<div class="course_body">
								<div class="course_header">
								...
								<div class="course_title">
									<h3><a href="project-details.php">Winter Clothing Distribution</a></h3>
								</div>
					...
					<div class="owl-item">
						<div class="course">
							<div class="course_image">
								<a href="project-details.php">
									<img src="images/SocialWork3.jpg" alt="Iftar Meals">
								</a>
							</div>
							<div class="course_body">
								<div class="course_header">
								...
								<div class="course_title">
									<h3><a href="project-details.php">Iftar Meals Program</a></h3>
								</div>
