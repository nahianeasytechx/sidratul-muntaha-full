                    ...
                    <div class="footer-section">
                        <div class="footer-logo mb-4">
                            <a href="<?= BASE_URL ?>index.php" class="d-flex align-items-center text-decoration-none">
                                <img src="<?= BASE_URL ?>images/final-logo.png" alt="Sidratul Muntaha Logo">
                            </a>
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 mt-4 mt-md-0">
                    <div class="footer-section">
                        ...
                        <ul class="footer-links list-unstyled">
                            <li><a href="<?= BASE_URL ?>index.php"><i class="fa fa-angle-right me-2 mr-3"></i> Home</a></li>
                            <li><a href="<?= BASE_URL ?>about.php"><i class="fa fa-angle-right me-2 mr-3"></i> About Us</a></li>
                            <li><a href="<?= BASE_URL ?>activities.php"><i class="fa fa-angle-right me-2 mr-3"></i> Activities</a></li>
                            <li><a href="<?= BASE_URL ?>scholarship.php"><i class="fa fa-angle-right me-2 mr-3"></i> Scholarship</a></li>
                        </ul>
                    </div>
                </div>
                            ...
                            <li class="mb-3">
                                <div class="contact-item">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0"><?php echo htmlspecialchars($contact_info['address']); ?></p>
                                    </div>
                                </div>
                            </li>
                            <li class="mb-3">
                                <div class="contact-item">
                                    ...
                                    <div>
                                        <strong>Phone:</strong>
                                        <p class="mb-0"><a href="tel:<?php echo htmlspecialchars($contact_info['phone']); ?>"><?php echo htmlspecialchars($contact_info['phone']); ?></a></p>
                                    </div>
                                </div>
                            </li>
                            <li class="mb-3">
                                <div class="contact-item">
                                    ...
                                    <div>
                                        <strong>Email:</strong>
                                        <p class="mb-0"><a href="mailto:<?php echo htmlspecialchars($contact_info['email']); ?>"><?php echo htmlspecialchars($contact_info['email']); ?></a></p>
                                    </div>
                                </div>
                            </li>
                        </ul>
