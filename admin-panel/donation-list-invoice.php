...
<div class="content-wrapper">
    ...
    <div class="invoice-header">
        ...
        <div class="invoice-title">
            <h1>INVOICE</h1>
            <p>Invoice #: DN-2024-001</p>
            <p>Date: October 26, 2025</p>
            <span class="invoice-type-badge">DONATION LIST</span>
        </div>
    </div>
    ...
    <div class="invoice-details">
        ...
        <div class="detail-section">
            <h3>To:</h3>
            <p><strong>Donor Name:</strong> Ahmed Hassan</p>
    ...
    <table class="invoice-table">
        ...
        <tbody>
            <tr>
                <td>1</td>
                <td>Hospital Project</td>
                <td>Healthcare</td>
                <td>5,000</td>
            </tr>
            <tr>
                <td>2</td>
                <td>Mosque Construction</td>
